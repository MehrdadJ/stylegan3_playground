...
class Generator(torch.nn.Module):
    ...
    def forward(self, z, c, truncation_psi=1, truncation_cutoff=None, update_emas=False, **synthesis_kwargs):
        ...
        # Modify the following loop to save intermediate feature maps
        for block_idx, block in enumerate(self.blocks):
            # ... (rest of the code remains unchanged)
            
            x = block(x, img_features, w_broadcasted, force_fp32=force_fp32, fused_modconv=fused_modconv)

            # Save the feature map of this block
            self.intermediate_features.append(x)

        return img

    #Mehrdad
    # Add this method to retrieve the stored feature maps
